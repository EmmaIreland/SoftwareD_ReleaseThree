                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="person"><g:message code="enrollment.person.label" default="Person" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: enrollmentInstance, field: 'person', 'errors')}">
                                    <g:select name="person.id" from="${survey.Person.list()}" optionKey="id" value="${enrollmentInstance?.person?.id}"  />
                                </td>
                            </tr>
